...
export function RestaurantPOS() {
  ...
  // Mock data fetching functions to simulate an API call
    ...
    return [
      {
        ...
        table: "Table 5",
        items: [
          { ...fetchMenuItems()[0], quantity: 2 },
          { ...fetchMenuItems()[1], quantity: 2 },
          { ...fetchMenuItems()[2], quantity: 1 },
        ],
      ...
      },
      {
        ...
        table: "Table 12",
        items: [
          { ...fetchMenuItems()[3], quantity: 1 },
          { ...fetchMenuItems()[4], quantity: 2 },
        ],
  ...
  useEffect(() => {
    ...
    setActiveOrders(fetchActiveOrders());
  }, []);
  ...
  return (
    <div className="space-y-6">
      ...
      <Dialog open={!!submittedOrder} onOpenChange={() => setSubmittedOrder(null)}>
        <DialogContent className="max-w-md">
            <DialogHeader>
                <DialogTitle>Order Submitted</DialogTitle>
                <DialogDescription>
                    Your order has been successfully placed. You can now print the receipt.
                </DialogDescription>
            </DialogHeader>
            <div className="hidden">
              <Receipt order={submittedOrder!} ref={componentRef} />
            </div>
            <div className="p-4 border rounded-md">
              <p className="font-semibold">Order ID: {submittedOrder?.id}</p>
              <p>Table: {submittedOrder?.table}</p>
              <p className="mt-2 text-lg font-bold">Total: KSh {submittedOrder?.total.toLocaleString()}</p>
            </div>
            <DialogFooter>
                <Button variant="outline" onClick={() => setSubmittedOrder(null)}>
                    Done
                </Button>
